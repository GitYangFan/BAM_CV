...
model = cl_combine.model_combine(n_channels_main=16, n_channels2=16, data_layers=0, cov_layers=10, inner_channels=256, N_exp=3,
                                 N_heads=4, num_classes=num_class)
