...
class model_attention_final(tf.keras.Model):
    ...
    def call(self, inputs, **kwargs):
        ...
        cov_euklidean_reshape = tf.reshape(cov_euklidean, shape=(-1, -1, -1, 1))  # shape (N, c, c, 1)
        fusion = feature_fusion(conv1, cov_euklidean_reshape, weight1=self.weight1, weight2=self.weight2)
